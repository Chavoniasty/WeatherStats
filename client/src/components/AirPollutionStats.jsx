...
function AirPollutionStats() {
    ...
    return (
        <div className="flex flex-col items-center justify-center lg:w-2/3 lg:h-full">
            <fieldset className="flex flex-col mt-4 border-4 border-orange-400 shadow-lg lg:mt-0 rounded-xl lg:h-3/4 lg:w-3/4 lg:pt-2 lg:px-4 bg-gradient-to-t from-orange-100/80 ">
                <legend className="px-2 text-xl font-bold text-orange-400 bg-white"> Compare Air Pollution around the World</legend>
                <div className="flex flex-row items-center gap-4 lg:w-full">
